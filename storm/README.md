...
charts for ```zookeeper``` is in **[charts](charts)** folder.
...
| `nimbus.image.tag`                | Container image version     | 1.2.2               |
...
| `supervisor.image.tag`            | Container image version     | 1.2.2               |
...
| `ui.image.tag`                    | UI image version            | 1.2.2               |
...
| `zookeeper.service.name`          | Service name                | storm-zookeeper           |
